...
int main() {
    ...
    Filter* f = new Filter(srcElem, srcMask, srcPort, destElem, destMask, destPort, proto);
    Filter* f2 = new Filter(srcElem, srcMask, srcPort, destElem2, destMask2, destPort, proto);
    vector<Filter*> fv;
    fv.push_back(f);
    fv.push_back(f2);
